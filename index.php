		...
		<div class="container body">
			<div class="main_container">
				<div class="col-md-3 left_col">
					<div class="left_col scroll-view">
						<div class="navbar nav_title" style="border: 0;">
							<a href="index.php" class="site_title"><i class="fa fa-home"></i>	SIPS</a>
						</div>
						...
						<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
							<div class="menu_section">
								<ul class="nav side-menu">
									...
									<li><a><i class="fa fa-edit"></i>Daftar Surat<span class="fa fa-chevron-down"></span></a>
				...
				<footer>
					...
					<strong>© SIPS.</strong> All right reserved
					</div>
					<div class="clearfix"></div>
				</footer>
				<!-- /footer content -->
  ...
  $(function () {
    ...
    <?php
    	//
          ...
          $count1b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal_surat AS total FROM surat_keluar WHERE MONTH(tanggal_surat)='1'"));
          $count2b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal_surat AS total FROM surat_keluar WHERE MONTH(tanggal_surat)='2'"));
          $count3b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal_surat AS total FROM surat_keluar WHERE MONTH(tanggal_surat)='3'"));
          $count4b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal_surat AS total FROM surat_keluar WHERE MONTH(tanggal_surat)='4'"));
          $count5b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal_surat AS total FROM surat_keluar WHERE MONTH(tanggal_surat)='5'"));
          $count6b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal_surat AS total FROM surat_keluar WHERE MONTH(tanggal_surat)='6'"));
          $count7b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal_surat AS total FROM surat_keluar WHERE MONTH(tanggal_surat)='7'"));
          $count8b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal_surat AS total FROM surat_keluar WHERE MONTH(tanggal_surat)='8'"));
          $count9b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal_surat AS total FROM surat_keluar WHERE MONTH(tanggal_surat)='9'"));
          $count10b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal_surat AS total FROM surat_keluar WHERE MONTH(tanggal_surat)='10'"));
          $count11b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal_surat AS total FROM surat_keluar WHERE MONTH(tanggal_surat)='11'"));
          $count12b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal_surat AS total FROM surat_keluar WHERE MONTH(tanggal_surat)='12'"));
    ?>
    //BAR CHART
    var bar = new Morris.Bar({
      ...
      data: [
        ...
        {y: 'Mar', a: '<?php echo $count3a ?>', b: '<?php echo $count3b ?>'},
        {y: 'Apr', a: '<?php echo $count4a ?>', b: '<?php echo $count4b ?>'},
        {y: 'Mei', a: '<?php echo $count5a ?>', b: '<?php echo $count5b ?>'},
        {y: 'Jun', a: '<?php echo $count6a ?>', b: '<?php echo $count6b ?>'},
        {y: 'Jul', a: '<?php echo $count7a ?>', b: '<?php echo $count7b ?>'},
