				...
				<div class="x_panel">
					...
					<div class="x_content">
						<div class="col-md-10 col-lg-10 col-sm-10">
							...
							<center>
								<a href="http://localhost/phpmyadmin/db_structure.php?server=1&db=sips&token=ec9acb23ddff04f9dc054f95d34b8ff3" class="btn btn-success" target="_blank"><i class="fa fa-upload"></i> Restore</a>
							</center>
