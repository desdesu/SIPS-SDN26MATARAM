 							...
 							<tbody>
 								<tr>
									...
									<td style="vertical-align: middle;"><?php echo $data['tujuan'] ?></td>
 									<td style="vertical-align: middle;"><b>File:</b><a href="upload/surat_keluar/<?php echo $data['file'];?>" class="btn btn-default btn-xs fa fa-download">&nbsp;<?php echo $data['file']?></a></td>
 									<td>
 										<center>
 											<a href="index.php?page=edit_surat_keluar&id=<?php echo $data['id_keluar']; ?>" class="btn btn-warning" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
 											<a href="index.php?page=hapus_surat_keluar&id=<?php echo $data['id_keluar'] ?>" class="btn btn-danger" title="Hapus"><i class="fa fa-trash-o"></i></a>
 										</center>
 									</td>
 								</tr>
 								<?php 
