	...
	<div class="">
		...
		<div class="">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_content">
						<table id_user="user" class="table table-striped table-bordered table-hover">
							<thead>
							...
							<tbody>
								<tr>
									...
									<td>
										<center>
											<a href="index.php?page=edit_users&id=<?php echo $data['id_user'] ?>" class="btn btn-warning" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
											<a href="index.php?page=hapus_users&id=<?php echo $data['id_user'] ?>" class="btn btn-danger" title="Hapus"><i class="fa fa-trash-o"></i></a>
										</center>
									</td>
								</tr>
								<?php 
